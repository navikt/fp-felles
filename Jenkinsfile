            ...
            steps {
                script {
                    ...
                    configFileProvider(
                        ...
                        sh "mvn -U -B -s $MAVEN_SETTINGS -Dfile.encoding=UTF-8 -Dsha1= -Dchangelist=-SNAPSHOT -Drevision=$tagName clean deploy"
            ...
            steps {
                script {
                    configFileProvider(
                        ...
                        sh "mvn -U -B -s $MAVEN_SETTINGS -Dfile.encoding=UTF-8 -DdeployAtEnd=true -Dsha1= -Dchangelist= -Drevision=$version clean deploy"
                    }
                }
            }
        }
