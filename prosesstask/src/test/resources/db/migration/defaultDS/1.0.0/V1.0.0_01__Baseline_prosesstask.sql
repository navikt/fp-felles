...
(
  ...
  "SISTE_KJOERING_TS_STATUS"  TIMESTAMP(6),
...
COMMENT ON COLUMN "PROSESS_TASK"."SISTE_KJOERING_TS_STATUS" IS 'tidsstempel siste gang tasken ble kjørt (etter kjøring) og fikk ny status';
