...
class PersondataKlientTest {
    ...
    void skal_returnere_person() throws IOException {
        ...
        var projection = new PersonResponseProjection().navn(new NavnResponseProjection().fornavn());
    ...
    void skal_returnere_ident() throws IOException {
        ...
        var projection = new IdentlisteResponseProjection().identer(new IdentInformasjonResponseProjection().ident().gruppe());
