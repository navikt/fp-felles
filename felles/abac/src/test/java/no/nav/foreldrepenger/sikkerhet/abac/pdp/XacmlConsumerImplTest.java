...
public class XacmlConsumerImplTest {
    ...
    public static void setUp() throws Exception {
        logSniffer = MemoryAppender.sniff(XacmlConsumerImpl.class);
    ...
    public void en_401_lager_ny_klient_og_logger_det() {
        ...
        XacmlConsumerImpl impl = new XacmlConsumerImpl(fakeEndPoint, "user", "pass");
        ...
        assertThat(logSniffer.search("F-563467", Level.WARN)).isNotEmpty();
    }
