...
public class TilgangPersondataTest {
    ...
    void test_response() throws Exception {
        var deserialized = DefaultJsonMapper.fromJson(PERSON_RESPONS, TilgangPersondataDto.class);
    ...
    @Test
    void test_response_bolk() throws Exception {
        var deserialized = DefaultJsonMapper.mapFromJson(PERSON_BOLK_RESPONS, TilgangPersondataDto.class);
        assertThat(deserialized).isNotNull();
