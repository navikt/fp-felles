 ...
 */
public class NavAbacCommonAttributter {
    ...
    public static final String XACML10_ACTION_ACTION_ID = "urn:oasis:names:tc:xacml:1.0:action:action-id";
    ...
    public static final String ENVIRONMENT_FELLES_SUBJECT_TYPE = "no.nav.abac.attributter.subject.felles.subjectType";
}
